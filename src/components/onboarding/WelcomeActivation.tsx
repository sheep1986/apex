import { BookOpen, Calendar, CheckCircle, Phone, Rocket } from 'lucide-react';
  ...
  return (
    <div className="space-y-6">
      <div className="text-center">
        ...
        <h2 className="mb-4 text-3xl font-bold text-white">🎉 Welcome to Trinity Labs AI!</h2>
              ...
              <li className="flex items-start">
                ...
                <div>
                  ...
                  <div className="text-sm text-gray-400">
                    Login at {data.provisioning?.subdomain}.trinity-labs.ai
                  </div>
                </div>
              </li>
              <li className="flex items-start">
