...
export default function WelcomeDashboard() {
  ...
  const quickActions: QuickAction[] = [
    ...
    },
    {
      ...
      action: () => navigate('/voice-dashboard?tab=assistants'),
    },
    {
      id: 'launch-campaign',
  ...
  const demoLink = 'https://trinity-labs.ai/demo';
        ...
        <CardContent className="p-6">
          <div className="space-y-4 text-center">
            ...
            <div className="flex justify-center space-x-4">
              ...
              <Button
                variant="outline"
                onClick={() => window.open('mailto:support@trinity-labs.ai', '_blank')}
                className="border-gray-600 text-gray-300 hover:bg-gray-800"
              >
              ...
              <Button
                onClick={() => window.open('https://calendly.com/trinity-labs/success-call', '_blank')}
                className="bg-gradient-to-r from-brand-pink to-brand-magenta hover:from-brand-magenta hover:to-brand-pink"
              >
