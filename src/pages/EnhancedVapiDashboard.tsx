...
import { Plus, RefreshCw, Target, Phone, Users, DollarSign, TrendingUp } from 'lucide-react';
...
interface EnhancedVapiDashboardProps {
  campaignId?: string;
}

export const EnhancedVapiDashboard: React.FC<EnhancedVapiDashboardProps> = ({ campaignId }) => {
