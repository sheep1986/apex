...
const STEPS = [
  ...
  { id: 4, name: 'VAPI Setup', icon: Settings },
...
export default function OrganizationSetupWizard() {
  ...
  const completeSetup = async () => {
    ...
    try {
      ...
      const setupData = {
        ...
        // Step 4: VAPI Setup
        vapiApiKey: organizationData.vapiApiKey,
        vapiPrivateKey: organizationData.vapiPrivateKey,
      };
    ...
    switch (currentStep) {
          ...
          <div className="space-y-6">
            <div>
              ...
              <p className="mb-6 text-sm text-gray-400">
                Tell us about your business to get started with the Apex AI Calling Platform
              </p>
            </div>
      ...
      case 4:
        return (
          <div className="space-y-6">
            <div>
              <h3 className="mb-2 text-lg font-medium text-white">VAPI Integration Setup</h3>
              <p className="mb-6 text-sm text-gray-400">
                Configure your VAPI account to enable AI calling functionality
              </p>
            </div>
            ...
            <Alert className="border-blue-700 bg-blue-900/20">
              ...
              <AlertDescription className="text-blue-300">
                <div className="space-y-2">
                  <p className="font-medium">How to set up your VAPI account:</p>
                  <ol className="list-inside list-decimal space-y-1 text-sm">
                    ...
                    <li>Navigate to your dashboard and go to "API Keys"</li>
                    <li>Generate a new API key and copy it</li>
                    <li>Also copy your Private Key from the account settings</li>
                    <li>Paste both keys below to connect your account</li>
                  </ol>
                </div>
              </AlertDescription>
            </Alert>
            ...
            <div className="space-y-4">
              <div>
                <div className="flex items-center justify-between">
                  ...
                  >
                    {showVapiKeys ? <EyeOff className="h-4 w-4" /> : <Eye className="h-4 w-4" />}
                  </Button>
                </div>
                <Input
              ...
              <AlertDescription className="text-green-300">
                <div className="space-y-2">
                  ...
                  <ul className="list-inside list-disc space-y-1 text-sm">
                    <li>Your VAPI account will be connected to the platform</li>
                    <li>You'll be able to create AI voice agents</li>
                    <li>Phone numbers can be purchased and configured</li>
                    <li>AI calling campaigns can be launched</li>
                  </ul>
                </div>
              </AlertDescription>
            </Alert>
            ...
            <div className="rounded-lg bg-gray-800/50 p-4">
              <h4 className="mb-2 font-medium text-white">Security Note</h4>
              <p className="text-sm text-gray-400">
                Your API keys are encrypted and stored securely. They are only used to authenticate
                with VAPI services and are never shared with third parties.
              </p>
            </div>
          </div>
        );
          ...
          <div className="space-y-6">
            ...
            <Card className="border-gray-700 bg-gray-800">
              ...
              <CardContent className="space-y-3">
                <div className="grid grid-cols-1 gap-4 md:grid-cols-2">
                  <div>
                    <Label className="text-sm text-gray-400">API Key Status</Label>
                    <p className="flex items-center gap-2 font-medium text-white">
                  ...
                  <div>
                    <Label className="text-sm text-gray-400">Private Key Status</Label>
                    <p className="flex items-center gap-2 font-medium text-white">
                      <CheckCircle className="h-4 w-4 text-green-500" />
                      Configured
                    </p>
                ...
                <Alert className="border-green-700 bg-green-900/20">
                  <CheckCircle2 className="h-4 w-4 text-green-400" />
                  <AlertDescription className="text-green-300">
                    VAPI integration is ready. You'll be able to create AI voice agents and launch
                    calling campaigns immediately after setup.
                  </AlertDescription>
                </Alert>
              </CardContent>
            </Card>
              ...
              <CardContent className="p-6">
                ...
                <div className="grid grid-cols-2 gap-4 md:grid-cols-4">
                  ...
                  <div className="text-center">
                    ...
                    <div className="text-sm text-gray-400">VAPI Ready</div>
                  </div>
                </div>
              </CardContent>
            </Card>
              ...
              <AlertDescription className="text-blue-300">
                <div className="space-y-2">
                  ...
                  <ul className="list-inside list-disc space-y-1 text-sm">
                    ...
                    <li>VAPI integration will be activated for AI calling</li>
  ...
  const isStepValid = () => {
    switch (currentStep) {
      ...
      case 4:
        return organizationData.vapiApiKey && organizationData.vapiPrivateKey;
      case 5:
        return true;
      default:
        return false;
                  ...
                  <div className="space-y-4">
                    ...
                    <div className="flex items-start gap-3">
                      ...
                      <div>
                        ...
                        <p className="text-sm text-gray-400">
                          VAPI Status:{' '}
                          {setupResult.vapiStatus?.connected
                            ? '✅ Ready'
          ...
          <div className="mb-6 flex items-center justify-between">
            <div className="flex items-center gap-3">
              ...
              <div>
                ...
                <p className="text-gray-400">
                  Set up your organization on the Apex AI Calling Platform
                </p>
              </div>
            </div>
