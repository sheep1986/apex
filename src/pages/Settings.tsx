...
export default function Settings() {
  ...
  const [showApiKeys, setShowApiKeys] = useState({
    payment: { publicKey: false, secretKey: false, webhookSecret: false },
    llm: { apiKey: false },
    database: { anonKey: false, serviceRoleKey: false },
  });
    ...
    try {
      ...
      if (!isValid) {
        toast({
          ...
          description: `Please check your configuration values.`,
          variant: "destructive",
        });
        setSaving(false);
        return;
                    ...
                    <>
                      ...
                      <Card className="border-gray-800 bg-gray-900">
                        <CardHeader>
                          ...
                          <CardDescription className="text-gray-400">
                            Configure payment processing integration for
                        ...
                        <CardContent className="space-y-4">
                          <div className="grid grid-cols-1 gap-4 md:grid-cols-2">
                            <div>
                              ...
                              <div className="relative">
                                <Input
                                  id="paymentPublicKey"
                                  type={
                                    showApiKeys.payment.publicKey
                                      ? "text"
                                      : "password"
                                  }
                                  value={apiConfigs.payment.publicKey}
                                  onChange={(e) =>
                                    setApiConfigs((prev) => ({
                                      ...prev,
                                      payment: {
                            ...
                            <div>
                              ...
                              <div className="relative">
                                <Input
                                  id="paymentSecretKey"
                                  type={
                                    showApiKeys.payment.secretKey
                                      ? "text"
                                      : "password"
                                  }
                                  value={apiConfigs.payment.secretKey}
                                  onChange={(e) =>
                                    setApiConfigs((prev) => ({
                                      ...prev,
                                      payment: {
                            ...
                            <div>
                              ...
                              <div className="relative">
                                <Input
                                  ...
                                  type={
                                    showApiKeys.payment.webhookSecret
                                      ? "text"
                                      : "password"
                                  }
                                  value={apiConfigs.payment.webhookSecret}
                                  onChange={(e) =>
                                    setApiConfigs((prev) => ({
                                      ...prev,
                                      payment: {
                            ...
                            <div>
                              ...
                              <div className="flex items-center space-x-2 mt-2">
                                <Switch
                                  id="paymentTestMode"
                                  checked={apiConfigs.payment.testMode}
                                  onCheckedChange={(checked) =>
                                    setApiConfigs((prev) => ({
                                      ...prev,
                                      payment: {
                          ...
                          <div className="flex justify-end">
                            <Button
                              onClick={() => handleApiConfigSave("payment")}
                              className="bg-emerald-600 hover:bg-emerald-700"
                            >
                              <Save className="mr-2 h-4 w-4" />
                              Save Payment Config
                      ...
                      <Card className="border-gray-800 bg-gray-900">
                        <CardHeader>
                          ...
                          <CardDescription className="text-gray-400">
                            Configure LLM integration for AI-powered features
                            and call analysis.
                          </CardDescription>
                        </CardHeader>
                        <CardContent className="space-y-4">
                          <div className="grid grid-cols-1 gap-4 md:grid-cols-2">
                            <div>
                              ...
                              <div className="relative">
                                <Input
                                  id="llmApiKey"
                                  type={
                                    showApiKeys.llm.apiKey
                                      ? "text"
                                      : "password"
                                  }
                                  value={apiConfigs.llm.apiKey}
                                  onChange={(e) =>
                                    setApiConfigs((prev) => ({
                                      ...prev,
                                      llm: {
                            ...
                            <div>
                              ...
                              <Input
                                id="llmOrgId"
                                value={apiConfigs.llm.organizationId}
                                onChange={(e) =>
                                  setApiConfigs((prev) => ({
                                    ...prev,
                                    llm: {
                          ...
                          <div className="flex justify-end">
                            <Button
                              onClick={() => handleApiConfigSave("llm")}
                              className="bg-emerald-600 hover:bg-emerald-700"
                            >
                              <Save className="mr-2 h-4 w-4" />
                              Save LLM Config
                      ...
                      <Card className="border-gray-800 bg-gray-900">
                        <CardHeader>
                          ...
                          <CardDescription className="text-gray-400">
                            Configure external database integration for client
                        ...
                        <CardContent className="space-y-4">
                          <div className="grid grid-cols-1 gap-4 md:grid-cols-2">
                            ...
                            <div>
                              ...
                              <div className="relative">
                                <Input
                                  id="databaseAnonKey"
                                  type={
                                    showApiKeys.database.anonKey
                                      ? "text"
                                      : "password"
                                  }
                                  value={apiConfigs.database.anonKey}
                                  onChange={(e) =>
                                    setApiConfigs((prev) => ({
                                      ...prev,
                                      database: {
                            ...
                            <div>
                              ...
                              <div className="relative">
                                <Input
                                  id="databaseServiceKey"
                                  type={
                                    showApiKeys.database.serviceRoleKey
                                      ? "text"
                                      : "password"
                                  }
                                  value={apiConfigs.database.serviceRoleKey}
                                  onChange={(e) =>
                                    setApiConfigs((prev) => ({
                                      ...prev,
                                      database: {
                          ...
                          <div className="flex justify-end">
                            <Button
                              onClick={() => handleApiConfigSave("database")}
                              className="bg-emerald-600 hover:bg-emerald-700"
                            >
                              <Save className="mr-2 h-4 w-4" />
