...
export default function VoiceSettings() {
  ...
  const [settings, setSettings] = useState<VoiceSettings>({
    apiKey: '',
    webhookUrl: 'https://api.apexai.com/webhooks/voice',
    enabled: false,
    assistantId: '',
    phoneNumberId: '',
    voiceId: 'shimmer',
  ...
  const loadSettings = async () => {
    try {
      setLoading(true);
      // Determine endpoint based on environment or use generic
      const response = await simpleApiClient.get('/settings/voice');
      if (response.data) {
      ...
      console.error('Error loading Voice Engine settings:', error);
    } finally {
      setLoading(false);
    }
  };
  ...
  const saveSettings = async () => {
    try {
      setSaving(true);
      await simpleApiClient.put('/settings/voice', settings);
      toast({
        title: 'Settings saved',
        description: 'Your Voice Engine integration settings have been updated successfully.',
      });
    } catch (error) {
      console.error('Error saving Voice Engine settings:', error);
      toast({
  ...
  const testConnection = async () => {
    try {
      ...
      const response = await simpleApiClient.post('/settings/voice/test', {
      ...
      if (response.data.success) {
        ...
        toast({
          ...
          description: 'Voice Engine API connection is working correctly.',
        });
      } else {
        setConnectionStatus('disconnected');
        toast({
          title: 'Connection failed',
          description: response.data.error || 'Failed to connect to Voice Engine API.',
          variant: 'destructive',
        });
      }
    } catch (error) {
      ...
      toast({
        title: 'Connection failed',
        description: 'Failed to test Voice Engine API connection.',
        variant: 'destructive',
      });
    } finally {
      setTesting(false);
    ...
    return (
      <div className="min-h-screen bg-black flex items-center justify-center">
        <div className="text-center">
          ...
          <p className="text-gray-400">Loading Voice Engine settings...</p>
        </div>
      </div>
    );
  }
    ...
    <div className="min-h-screen bg-black">
      <div className="w-full space-y-6 px-4 sm:px-6 lg:px-8 py-6">
        ...
        <div className="mb-8 flex items-center justify-between">
          <div>
            <h1 className="text-3xl font-bold text-white">Voice Engine Integration</h1>
            <p className="text-gray-400">Configure your Voice API connection and assistant settings</p>
          ...
          <Card className="border-gray-800 bg-gray-900">
            <CardHeader>
              ...
              <CardDescription className="text-gray-400">
                Configure your Voice Engine API credentials and basic settings
              </CardDescription>
            </CardHeader>
              ...
              <div>
                ...
                <div className="mt-2 flex items-center space-x-2">
                  <Input
                    ...
                    placeholder="Enter your Voice Provider API Key"
                  />
              ...
              <div>
                ...
                <div className="mt-2 flex items-center space-x-2">
                  <Input
                    ...
                    className="border-gray-700 bg-gray-800 text-white"
                    placeholder="https://api.apexai.com/webhooks/voice"
                  />
                  <Button
                    variant="outline"
                    size="sm"
              ...
              <div className="flex items-center justify-between rounded-lg bg-gray-800/50 p-3">
                <div>
                  ...
                  <p className="text-sm text-gray-400">
                    Turn on Voice Engine integration for your organization
                  </p>
                </div>
                <Switch
            ...
            <CardContent className="space-y-4">
              <div>
                ...
                <Input
                  ...
                  placeholder="Your Voice Assistant ID"
                />
              </div>
              ...
              <div>
                ...
                <Input
                  ...
                  className="mt-2 border-gray-700 bg-gray-800 text-white"
                  placeholder="Your Voice Phone Number ID"
                />
              </div>
