...
function Onboarding() {
  ...
  const [assistantConfig, setAssistantConfig] = useState<AssistantConfig>({
    ...
    keyInfo: ['Name', 'Email', 'Phone', 'Company', 'Interest Level'],
    isActive: true,
    createdAt: new Date(),
    updatedAt: new Date(),
  });
  ...
  const [steps, setSteps] = useState<OnboardingStep[]>([
    ...
    },
    {
      ...
      description: 'Set up VAPI, Airtable, and Make.com connections',
      icon: Key,
      completed: false,
    },
    {
        ...
        return (
          <div className="space-y-6">
            <div className="mb-8 text-center">
              ...
              <p className="text-gray-400">Link your VAPI, Airtable, and Make.com accounts</p>
            </div>
            ...
            <Card className="border-gray-700 bg-gray-800">
              ...
              <CardContent className="space-y-4">
                <p className="text-sm text-gray-400">
                  VAPI powers the AI voice calls. Get your API key from{' '}
                  <a
                    href="https://vapi.ai"
                    target="_blank"
                  ...
                  >
                    vapi.ai <ExternalLink className="inline h-3 w-3" />
                  </a>
                </p>
                <div className="flex space-x-2">
                  <Input
                    id="vapiKey"
                    type="password"
                    value={integrationKeys.vapi.apiKey}
                    onChange={(e) =>
                      setIntegrationKeys({
                        ...integrationKeys,
                        vapi: { ...integrationKeys.vapi, apiKey: e.target.value },
                      })
                    }
                    className="border-gray-700 bg-gray-800 text-white"
                  ...
                  <Button
                    ...
                    disabled={!integrationKeys.vapi.apiKey || testingConnection === 'vapi'}
                  >
              ...
              <CardContent className="p-6">
                ...
                <div className="space-y-3">
                  <div className="flex items-center space-x-3">
                    ...
                    <span className="text-gray-300">Your AI assistant will be created in VAPI</span>
                  </div>
                  <div className="flex items-center space-x-3">
                    <CheckCircle className="h-5 w-5 text-green-400" />
