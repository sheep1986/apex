...
console.log("main.tsx: Environment:", {
  ...
  VITE_CLERK_KEY: import.meta.env.VITE_CLERK_PUBLISHABLE_KEY
    ? "Present"
    : "Missing",
...
const clerkPubKey =
  ...
  "pk_test_dW5pdGVkLWNob3ctMTMuY2xlcmsuYWNjb3VudHMuZGV2JA";
...
function DiagnosticApp() {
  return (
    ...
    >
      <h1>Trinity Labs AI - Diagnostic Mode</h1>
...
if (!rootElement) {
  ...
  document.body.innerHTML =
    '<div style="color: white; padding: 20px;">Error: Root element not found in DOM</div>';
} else {
