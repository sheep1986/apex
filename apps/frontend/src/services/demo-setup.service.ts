...
export class DemoSetupService {
  ...
  static async initializeDemoData(): Promise<void> {
    ...
    try {
      // Add demo VAPI accounts
      await this.setupDemoVapiAccounts();

      // Add demo notifications
      await this.setupDemoNotifications();

      // Simulate some real-time activity
      this.startDemoActivity();
...
export const resetDemoData = DemoSetupService.resetDemoData.bind(DemoSetupService);
export const getDemoStats = DemoSetupService.getDemoStats.bind(DemoSetupService);
export const autoInitialize = DemoSetupService.autoInitialize.bind(DemoSetupService);
